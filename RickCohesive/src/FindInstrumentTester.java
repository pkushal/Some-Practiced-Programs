...
public class FindInstrumentTester {
	...
	private static void initializeInventory(Inventory inventory) {
		...
		inventory.addInstrument("122784", 5495.95, new InstrumentSpec(
				properties));
		...
		inventory.addInstrument("V95693", 1499.95, new InstrumentSpec(
				properties));
		...
		inventory.addInstrument("82765501", 1890.95, new InstrumentSpec(
				properties));
		...
		inventory.addInstrument("9019920", 5495.99, new InstrumentSpec(
				properties));
		...
		inventory.addInstrument("8900231", 2945.95, new InstrumentSpec(
				properties));
	}
}
